  ...
  return (
    <div className={`${font}`}>
      <div className="ml-36 mr-15 mt-10 mb-20">
        <h1 className="text-[25px]">Add a new ingredient</h1>
        <br></br>
        <div className="mt-1">
          <form className="space-y-1" action="#" method="POST">
            <div>
              <label
                htmlFor="ingredientItemsName"
                className={`text-[16px] block font-medium leading-6 text-zinc-500 ${font}`}
              >
                Ingredient Name
              </label>
              <div className="mt-1">
            ...
            <div className="flex">
              <div className="flex-1">
                <button className="bg-[#fa6161] text-white text-bold rounded-full px-5 py-2 md:py-1 mt-7 md:mt-7 hover:bg-red-600">
                  Clear Input
                </button>
              </div>

              <div className="flex-1 ml-5">
                <button className="bg-[#24B26E] text-white text-bold rounded-full px-5 py-2 md:py-1 mt-7 md:mt-7 hover:bg-green-700">
                  Add List
                </button>
              </div>
            </div>
