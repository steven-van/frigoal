            ...
            <div class="box-border border-1 shadow-2xl">
                <div class="flex min-h-0">
                    ...
                    <div className="flex-1 bg-[#65C9FF] relative">
                        ...
                        <div
                            className={`z-7 absolute font-bold text-[20px] text-slate-50 ml-6 mt-[450px] lg:text-[35px] lg:mt-[360px] lg:ml-[50px] ${font}`}
                        >
                        ...
                        <div className="z-10 absolute">
                            <img
                                className="justify-center items-center mt-[230px] ml-7 w-[23vw] md:mt-[120px] md:ml-[50px] lg:mt-[90px] lg:ml-[130px]"
                                src={bonhomme}
                                alt="Icon Bonhomme"
                            />
                        </div>
