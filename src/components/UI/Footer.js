...
const Footer = () => {
  ...
  return (
    <footer>
      <div className="w-full bg-[#6097CE] left-0 text-white bottom-0">
        <div className="flex justify-center pb-2 gap-6 pt-4">
          <div className="flex w-16 justify-center gap-24">{linkElements}</div>
        </div>
        <div className="flex justify-center">
          <a href="https://github.com/steven-van/frigoal/">
            <img
              className="object-contain h-9 w-16 mb-4 mt-4"
              src={GitHub}
              alt="GitHub"
            />
          </a>
