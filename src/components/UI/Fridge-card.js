...
const Fridge = ({ id, name, color }) => {
    return (
        <div
            class={`h-64 w-80 max-w-sm m-2 p-4 overflow-hidden border border-gray-200 rounded-2xl relative shadow-md ${color}`}
        >
            ...
            <div class="flex flex-col items-left pb-10">
                <h5 class="mb-1 text-2xl z-10 w-2/3 font-black text-sky-950">{name}</h5>
